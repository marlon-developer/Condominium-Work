<?php    
    include('../../src/ClassContaBancaria.php');
    $objectContaBancaria = new ContaBancaria;
    $tableInfo = $objectContaBancaria->lista_dados();
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="./ContaBancaria.php"><i class="fa fa-circle-o"></i> Conta Bancária</a></li>
                                  ...
                                  <table class="table table-hover">
                                    ...
                                    <?php if(!empty($tableInfo)):?>
                                        <?php foreach ($tableInfo as $key => $value): ?>
                                            <tr>
                                              <td><?php echo $value['id_banco'] ?></td>
                                              <td><?php echo $value['agencia'] ?></td>
                                              <td><?php echo $value['agencia'] ?></td>
                                              <td><?php echo $value['conta'] ?></td>
                                              <td><span class="label <?php echo $label[$value['ativo']] ?>"><?php echo $status[$value['ativo']] ?></span></td>
                                              <td><button type="submit" onclick="location.href='../../src/ContaBancaria.php?action=delete&id=<?php echo $value['id_conta_bancaria']; ?>';" class="btn btn-danger" style="font-size:6px;"><i class="fa fa-close"></i></button></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else:?>
                                        <tr>
                                          <td colspan="6" align="center">Tabela sem informações</td>
                                        </tr>
                                    <?php endif;?>
                                  </tbody></table>
                                </div>
