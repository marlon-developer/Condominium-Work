<?php    
    include('../../src/Condominio.php');
    $cond = new Condominio;
    $tableInfo = $cond->Listar();

    //var_dump($tableInfo);
    
    // $tableInfo2 = Condominio::ListarCondominos($tableInfo['responsavel']);
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="ListarCondominios.php"><i class="fa fa-circle-o"></i> Despesas e Receitas</a></li>
                                ...
                                <div class="box-body table-responsive no-padding">
                                  <table class="table table-hover">
                                    ...
                                    <?php foreach ($tableInfo as $key => $value): ?>
                                        <tr>
                                          <td><?php echo $value['id_condominio'] ?></td>
                                          ...
                                          <td><?php echo $value['numero_total_unidades'] ?></td>
                                          <td><?php echo $value['nomeResponsavel'] ?></td>
                                          <td><?php echo $value['telefone'] ?></td>
                                          <td><?php echo $value['area_total'] ?></td>
                                          <td><?php echo $value['area_total_construida'] ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                  </tbody></table>
                                </div>
