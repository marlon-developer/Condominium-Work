...
<?php
    ...
    $listaContaCategoria = $query->DBRead('conta_categoria', 'ORDER BY titulo ASC', '*');
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="./ContaCategoria.php"><i class="fa fa-circle-o"></i> Conta Categoria</a></li>
                    </ul>
                </li>
                <li>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            <?php
                                                foreach ($listaContaCategoria as $contaCategoria){
                                                    echo "<tr><td>" . $contaCategoria['titulo'] . "</td>";
                                                    echo "<td>" . $contaCategoria['descricao'] . "</td></tr>";
                                                }
                                            ?>
                                        </tbody></table>
                                </div>
